...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.SyntheticEvent<HTMLFormElement>) {
    ...
    setSubmitting(true);
    try {
      await new Promise((r) => setTimeout(r, 700)); // TODO: real auth
    } catch {
  ...
  return (
    ...
    <div className="flex min-h-screen bg-[#F4F3F8] font-sans">
      ...
      <AuthLeftPanel
        headline={<>Unified Commerce<br /><span className="text-[#C4AFFE]">for Modern Markets</span></>}
        ...
        <div className="w-full max-w-[440px]">
          ...
          <div className="rounded-2xl bg-white px-8 py-9 shadow-sm ring-1 ring-black/5">
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-5">
              ...
              {/* email / username */}
              <div>
                <label htmlFor="identifier" className="mb-1.5 block text-[13px] font-semibold text-[#1A1330]">
                  Email or Username
                </label>
                <div className="relative">
                  <User size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#B0A8C8]" />
                  <input
                    id="identifier"
                    value={identifier}
              ...
              <div>
                <div className="mb-1.5 flex items-center justify-between">
                  <label htmlFor="password" className="text-[13px] font-semibold text-[#1A1330]">
                    Password
                  </label>
                  <Link
            ...
            <div className="my-6 flex items-center gap-3">
              ...
              <span className="text-[12px] font-medium text-[#B0A8C8]">or continue with</span>
              <div className="h-px flex-1 bg-[#EAE7F3]" />
            </div>
            ...
            <div className="flex justify-center gap-3">
              ...
              {/* Instagram */}
              <SocialBtn aria-label="Continue with Instagram" className="bg-black">
            ...
            {/* register link */}
            <div className="mt-7 rounded-xl border border-dashed border-[#DDD8EE] px-5 py-5 text-center">
          ...
          <p className="mt-5 text-center text-[11px] leading-relaxed text-[#A09AB8]">
            ...
            {" & "}
            <Link href="/privacy" className="font-medium text-[#6C4CD8] hover:underline">Privacy Policy</Link>.
          </p>
        </div>
      </div>
    </div>
...
function SocialBtn({ children, className, ...rest }: React.ButtonHTMLAttributes<HTMLButtonElement>) {
  return (
    <button
      type="button"
      className={cn(
