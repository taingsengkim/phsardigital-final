...
const itemClass =
  "flex h-[50px] w-full items-center gap-4 rounded-[26px] px-5 text-[15px] font-medium text-[#77746f] transition-colors hover:bg-primary/10 hover:text-primary dark:text-sidebar-foreground dark:hover:bg-primary/15 dark:hover:text-primary group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-0";
const activeClass =
  "bg-primary font-semibold text-primary-foreground hover:bg-primary hover:text-primary-foreground dark:bg-primary dark:text-primary-foreground";
...
export function SellerSidebar() {
  ...
  const [reportsOpen, setReportsOpen] = React.useState(
    pathname.includes("/products/dashboard") ||
      pathname.includes("/products/comment"),
  );
      ...
      >
        ...
        <SidebarContent className="overflow-x-hidden bg-white px-[18px] pb-5 pt-5 dark:bg-sidebar">
          <nav aria-label="Seller dashboard" className="space-y-[3px]">
            ...
            >
              ...
              <ChevronDown
                className={cn(
                  "ml-auto size-[18px] transition-transform group-data-[collapsible=icon]:hidden",
        ...
        <SidebarFooter className="bg-white px-[18px] pb-7 dark:bg-sidebar">
          ...
          <button
            ...
            className={cn(
              itemClass,
              "text-[#e74e58] hover:bg-red-50 hover:text-[#d93d48] dark:text-red-400 dark:hover:bg-red-500/10",
            )}
          >
      ...
      {logoutOpen && (
        ...
        >
          <div
            ...
            className="w-full max-w-md rounded-[28px] bg-white px-7 py-8 text-center shadow-[0_28px_80px_rgba(15,23,42,0.3)] dark:bg-slate-900 sm:px-9"
          >
            ...
            <div className="mt-7 grid grid-cols-2 gap-3">
              <button
                ...
                className="h-12 rounded-xl bg-slate-100 text-sm font-semibold text-slate-700 transition hover:bg-slate-200 disabled:opacity-50 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
              >
                Cancel
              </button>
              <button
